          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
            ...
            <div className="md:col-span-8 flex flex-col gap-6">
              ...
              <div className="bg-surface-container rounded-lg border border-surface-container-high p-6 flex flex-col gap-6 relative overflow-hidden">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  {[
                    { id: 'chroma',   name: 'ChromaDB',  badge: 'Local', isCloud: false },
                    { id: 'pinecone', name: 'Pinecone',  badge: 'Cloud', isCloud: true  },
                  ].map(db => {
                    ...
                    return (
                      <label key={db.id} className={`cursor-pointer relative rounded-lg border p-4 flex flex-col gap-2 transition-all ${
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          <span className={`text-[12px] font-semibold ${isSelected ? 'bg-secondary/20 text-secondary-container' : 'bg-surface-container-lowest text-on-surface-variant'} px-2 py-1 rounded`}>
                            {db.badge}
                          </span>
              ...
              <div className="flex items-center justify-end gap-6 mt-4">
                <button type="button" onClick={handleReset}
                  className="text-on-surface-variant hover:text-on-surface transition-colors text-[12px] font-semibold tracking-[0.05em]">
                  Reset to defaults
                </button>
                <button type="submit"
                  className="bg-primary-container hover:brightness-110 text-white px-8 py-3 rounded text-[12px] font-semibold tracking-[0.05em] shadow-lg shadow-primary-container/20 transition-all flex items-center gap-2">
            ...
            <div className="md:col-span-4 flex flex-col gap-6">
              <div className="bg-surface-container rounded-lg border border-surface-container-high p-6">
                ...
                <ul className="flex flex-col gap-4">
                  {envVars.map(ev => (
                    <li key={ev.key} className={`flex items-center justify-between p-3 rounded bg-[#05070A] border ${
                      ev.loaded ? 'border-surface-container-highest' : 'border-error/30 border-dashed'
                    }`}>
                      <div className="flex items-center gap-3">
                        <span className={`material-symbols-outlined icon-fill ${ev.loaded ? 'text-secondary-container' : 'text-error'}`} style={{ fontSize: '20px' }}>
